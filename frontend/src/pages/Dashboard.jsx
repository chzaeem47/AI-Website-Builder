              ...
              {websites.map((site, index) => (
                ...
                >
                  ...
                  <div className="relative flex gap-2">
                    ...
                    <button className="flex flex-1 items-center justify-center gap-1.5 rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-2 text-sm font-medium shadow-sm transition-all hover:shadow-md hover:opacity-95">
                      <FiExternalLink size={13} /> Deploy
                    </button>
                  </div>
                </div>
              ))}
