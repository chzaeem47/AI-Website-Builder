    ...
    <>
      ...
      {isGenerating && (
        <div className="fixed inset-0 z-[9998] flex items-center justify-center bg-[#0a0118]/85 backdrop-blur-2xl overflow-hidden">
          ...
          <div style={{ animation: "cardEntrance 0.5s cubic-bezier(0.16,1,0.3,1)" }} className="relative flex w-[90%] max-w-[520px] flex-col items-center justify-center rounded-[2rem] border border-white/10 bg-white/[0.06] p-10 sm:p-12 shadow-2xl backdrop-blur-2xl">
            <div className="relative mb-8 flex items-center justify-center w-[110px] h-[110px]">
              ...
              <div style={{ animation: "pulseCore 1.8s ease-in-out infinite" }} className="relative w-[38px] h-[38px] rounded-full bg-gradient-to-br from-pink-500 via-purple-500 to-cyan-400 shadow-[0_0_25px_rgba(168,85,247,0.6)]" />
            </div>
            <div className="w-full text-center min-h-[2.5rem] flex items-center justify-center px-2">
              <h2 style={{ animation: textVisible ? "fadeUp 0.35s ease" : "none", opacity: textVisible ? 1 : 0, transition: "opacity 0.25s ease" }} className="gradient-text-anim font-serif text-2xl sm:text-3xl font-bold tracking-tight">
            ...
            <button onClick={handleCancelGeneration} className="mt-8 flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.05] px-6 py-2.5 font-serif text-sm text-gray-200 hover:text-white hover:border-pink-400/40 hover:bg-white/10 transition-all duration-300 group">
